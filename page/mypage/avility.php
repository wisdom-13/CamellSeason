<?php 
$age = ($val1 == "1") ? "" : $val1;
$row = fetchAll("SELECT * FROM PLAYER, MEMBER, GROWTH where p_no = '{$_SESSION['p'.$age]}' and m_player$age = p_no and g_player = m_no"); 
?>
...
<script>
	$(document).ready(function(){
		...
		$(".join_back").on("click",function(){
			$(".join_back").stop().slideToggle(1000);
			$(".avility_page").stop().slideToggle(1000);
			location.href='/index.php/mypage/list/<?= $age ?>';
		});

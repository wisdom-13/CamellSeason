...
<table class="table">
	...
	<?php 
	$query = "select * from LETTER where l_to = '{$_SESSION['no']}' order by l_no desc";
	$i = rowAll($query)+1;
...
<a href="/index.php/letter/send" ><img style="margin-right: 10px;" class="letter_btn" src="/common/img/letter/send.png" onmouseover="this.src='/common/img/letter/send_hover.png';" onmouseout="this.src='/common/img/letter/send.png';"></a>

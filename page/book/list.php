<div style="text-align: center;">
	...
	<div class="book_content">
		<?php 
		foreach(query("select * from STORY where s_act = 1") as $row){ 
			if($row->s_yn == "2"){
				?><img src="/common/img/book/book1/lock.png"><?php	
			} else {
				?><a href="/index.php/book/view/<?= $row->s_no ?>"><img src="/common/img/book/book1/list<?= $row->s_chapter ?>.png"></a><?php
			}
		} ?>
	</div>
...
<style>
	...
	.book_content img { margin: 0 35px; }

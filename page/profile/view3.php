<?php $row = fetchAll("SELECT * FROM PLAYER, MEMBER, GROWTH where p_no = $val1 and m_player3 = p_no and g_player = m_no"); ?>
...
<div class="profile_body"><img width="700px" src="/admin/common/img/profile/3/body/<?= $row->p_no ?>.png"></div>
...
<div class="profile_content">
	...
	<div class="profile_mini">
		<div class="mini_head">
			<img width="250px;" src="/admin/common/img/profile/3/head/<?= $row->p_no ?>.png">
		</div>
		<div class="mini_text">
	...
	<div class="profile_avility">
		...
		<a href="/index.php/profile/avility3/<?= $row->p_no ?>">자세히보기</a>
	</div>
	...
	<br>
	<?php 
	$query = "select * from RELATION where r_player = '{$row->m_no}' and r_content_3 is not NULL";
	if(fetchAll($query)){; ?>
	<!--관계-->
	...
	<div class="p_re profile_box">
		...
		<div class="re_box">
			<div class="re_head">
				...
				<a href="/index.php/profile/view3/<?= $row->m_player3 ?>"><img width="140px;" src="/admin/common/img/profile/3/head/<?= $row->m_player3 ?>.png"></a>

...
<div class="profile_list">
	<?php foreach(query("select * from PLAYER where p_age = $G and p_class = '{$val1}' and p_use = 1") as $row){ ?>
		<a href="/index.php/profile/view/<?= $row->p_no ?>">
		<div class="profile_head">
			<img class="profile_head_list" src="/admin/common/img/profile/<?= $G ?>/head/<?= $row->p_no ?>.png">
 			...
 			<div class="profile_text">
				<?php $member = fetchAll("SELECT * FROM MEMBER where m_player = $row->p_no"); ?> 

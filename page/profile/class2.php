...
<div class="profile_list">
	<?php $G = "2"; foreach(query("select * from PLAYER p, MEMBER m where p_no = m_player2 and p_age = $G and p_class = '{$val1}' and p_use = 1 order by m_player") as $row){ ?>
		<a href="/index.php/profile/view2/<?= $row->p_no ?>">
		<div class="profile_head">
			<img class="profile_head_list" src="/admin/common/img/profile/<?= $G ?>/head/<?= $row->p_no ?>.png">
 			...
 			<div class="profile_text">
				<?php $member = fetchAll("SELECT * FROM MEMBER where m_player2 = $row->p_no"); ?> 

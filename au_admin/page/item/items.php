<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		<table class="table table-bordered t_system">
			...
			foreach(query("select * from AU_ITEM $type") as $row) { ?>
			<tr>
				<td><?= $row->i_no ?></td>
				<td><img width="100px" src="/au/common/img/item/<?= $row->i_name ?>.png"></td>
...
<div class="modal fade bs-example-modal-lg" id="add_item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<form action="/au_admin/index.php/ok/item/addItem" enctype="multipart/form-data" method="post" id="form1" runat="server">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-10">
						<label class="radio-inline">
							<input type="radio" name="type" id="type" value="1" checked> 일상
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="type" value="2"> 전투
						</label>
						<label class="radio-inline">
							<input type="radio" name="type" id="type" value="3"> 식권
						</label>
					</div>
				</div>
				<!--
